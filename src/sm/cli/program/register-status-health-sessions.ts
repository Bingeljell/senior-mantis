...
export function registerSeniorMantisStatusHealthSessionsCommands(program: Command) {
  program
    .command("status")
    .description("Show WhatsApp + local web UI health and recent sessions")
    .option("--json", "Output JSON instead of text", false)
    .option("--all", "Full diagnosis (read-only, pasteable)", false)
    .option("--usage", "Show model provider usage/quota snapshots", false)
    .option("--deep", "Run deeper WhatsApp provider probes", false)
  ...
  program
    .command("health")
    .description("Fetch health from the running local gateway")
    .option("--json", "Output JSON instead of text", false)
